...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { city_name: @complaint.city_name, latitude: @complaint.latitude, longitude: @complaint.longitude, species: @complaint.species, status: @complaint.status, user_id: @complaint.user_id }
    end
  ...
  test "should update complaint" do
    patch :update, id: @complaint, complaint: { city_name: @complaint.city_name, latitude: @complaint.latitude, longitude: @complaint.longitude, species: @complaint.species, status: @complaint.status, user_id: @complaint.user_id }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
